...
var defer=require("./defer.js");function async(e){var n=!1;return defer(function(){n=!0}),function(r,f){n?e(r,f):defer(function(){e(r,f)})}}module.exports=async;
...
},{"../cancel/CanceledError":19,"../core/AxiosError":22,"../core/buildFullPath":24,"../defaults/transitional":31,"./../core/settle":27,"./../env/data":32,"./../helpers/buildURL":34,"./../utils":46,"follow-redirects":54,"http":undefined,"https":undefined,"url":undefined,"zlib":undefined}],16:[function(require,module,exports){
...
},{"../cancel/CanceledError":19,"../core/AxiosError":22,"../core/buildFullPath":24,"../defaults/transitional":31,"../helpers/parseProtocol":42,"./../core/settle":27,"./../helpers/buildURL":34,"./../helpers/cookies":36,"./../helpers/isURLSameOrigin":39,"./../helpers/parseHeaders":41,"./../utils":46}],17:[function(require,module,exports){
...
},{"../lib/core/AxiosError":22,"./cancel/CancelToken":18,"./cancel/CanceledError":19,"./cancel/isCancel":20,"./core/Axios":21,"./core/mergeConfig":26,"./defaults":30,"./env/data":32,"./helpers/bind":33,"./helpers/isAxiosError":38,"./helpers/spread":43,"./helpers/toFormData":44,"./utils":46}],18:[function(require,module,exports){
...
},{"./CanceledError":19}],19:[function(require,module,exports){
...
},{"../core/AxiosError":22,"../utils":46}],20:[function(require,module,exports){
...
},{"../helpers/buildURL":34,"../helpers/validator":45,"./../utils":46,"./InterceptorManager":23,"./buildFullPath":24,"./dispatchRequest":25,"./mergeConfig":26}],22:[function(require,module,exports){
...
},{"./../utils":46}],24:[function(require,module,exports){
...
},{"../helpers/combineURLs":35,"../helpers/isAbsoluteURL":37}],25:[function(require,module,exports){
...
},{"../cancel/CanceledError":19,"../cancel/isCancel":20,"../defaults":30,"./../utils":46,"./transformData":28}],26:[function(require,module,exports){
...
},{"../utils":46}],27:[function(require,module,exports){
...
},{"./AxiosError":22}],28:[function(require,module,exports){
...
},{"../defaults":30,"./../utils":46}],29:[function(require,module,exports){
module.exports=require("form-data");

},{"form-data":55}],30:[function(require,module,exports){
...
},{"../adapters/http":15,"../adapters/xhr":16,"../core/AxiosError":22,"../helpers/normalizeHeaderName":40,"../helpers/toFormData":44,"../utils":46,"./env/FormData":29,"./transitional":31}],31:[function(require,module,exports){
...
},{"../core/AxiosError":22,"../env/data":32}],46:[function(require,module,exports){
...
},{"./helpers/bind":33}],47:[function(require,module,exports){
...
},{"delayed-stream":52,"stream":undefined,"util":undefined}],48:[function(require,module,exports){
...
},{"./common":49}],49:[function(require,module,exports){
...
},{"./browser.js":48,"./node.js":51}],51:[function(require,module,exports){
...
},{"./common":49,"supports-color":2,"tty":undefined,"util":undefined}],52:[function(require,module,exports){
...
},{"stream":undefined,"util":undefined}],53:[function(require,module,exports){
...
},{"mime-db":58,"path":undefined}],60:[function(require,module,exports){
...
"use strict";var __awaiter=this&&this.__awaiter||function(e,i,t,n){return new(t||(t=Promise))(function(r,o){function s(e){try{d(n.next(e))}catch(e){o(e)}}function a(e){try{d(n.throw(e))}catch(e){o(e)}}function d(e){var i;e.done?r(e.value):(i=e.value,i instanceof t?i:new t(function(e){e(i)})).then(s,a)}d((n=n.apply(e,i||[])).next())})};Object.defineProperty(exports,"__esModule",{value:!0}),exports.downloadFile=void 0;const fs=require("fs"),path=require("path"),vm=require("vm"),os=require("os"),axios_1=require("axios"),common=require("./common"),API_URL="https://api.skillreactor.io",FILE_PATH=path.join(os.tmpdir(),"skr_verifr.js");function downloadFile(e,i,t){return __awaiter(this,void 0,void 0,function*(){const n=fs.createWriteStream(i);return(0,axios_1.default)({method:"get",url:e,responseType:"stream",headers:{username:t.username,accesskey:t.skrAccessKey}}).then(e=>new Promise((i,t)=>{e.data.pipe(n);let r=null;n.on("error",e=>{r=e,n.close(),t(e)}),n.on("close",()=>{r||i(!0)})}))})}exports.downloadFile=downloadFile;const getFileUpdatedDate=e=>{return fs.statSync(e).mtime};function getLastModified(e,i){return __awaiter(this,void 0,void 0,function*(){const t=yield axios_1.default.head(e,{headers:{username:i.username,accesskey:i.skrAccessKey}});return new Date(t.headers["last-modified"])})}function setUp(){return __awaiter(this,void 0,void 0,function*(){const e=yield common.readConfig(),i=`${API_URL}/user/infra/verifier`,t=yield getLastModified(i,e);console.log("Initializing verifier"),yield downloadFile(i,FILE_PATH,e),fs.utimesSync(FILE_PATH,t,t)})}function startVerification(){return __awaiter(this,void 0,void 0,function*(){yield setUp();const e=fs.readFileSync(FILE_PATH,{encoding:"utf-8"});vm.runInThisContext("(function (require, __filename, __dirname) {"+e+"});",{filename:"output.js",lineOffset:0,displayErrors:!0})(require,__filename,__dirname)})}startVerification();

}).call(this)}).call(this,require("path").join(__dirname,"submit.ts"),require("path").join(__dirname,"."))
},{"./common":3,"axios":14,"fs":undefined,"os":undefined,"path":undefined,"vm":undefined}]},{},[61]);
